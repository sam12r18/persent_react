      ...
      <div className="row">
        ...
        <div>
          ...
          <div className="d-flex bg-orange justify-content-between rounded-4 p-3 mt-2">
            ...
            {role === "admin" && (
              <Link to="/admin-dashboard" className="btn fs-6 px-3 text-decoration-none text-white btn-green rounded-5">ورود</Link>
            )}
            {role === "employee" && (
              <Link to="/registration-of-attendance" className="btn fs-6 px-3 text-decoration-none text-white btn-green rounded-5">ورود </Link>
            )}
          </div>
