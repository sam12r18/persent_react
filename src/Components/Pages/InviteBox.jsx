...
export default function InviteBox() {
  ...
  const acceptRequest = () => {
    console.log("دعوت پذیرفته شد");
    // اینجا می‌تونی درخواست تایید رو بفرستی به سرور با axios
      ...
      <div className="row">
        ...
        <div>
          ...
          <div className="d-flex bg-orange justify-content-between rounded-4 p-3 mt-3">
            <span className="text-white fs-5 fw-bold">کارمند مایکروسافت</span>
            <div className="gap-3 d-flex">
              <button onClick={acceptRequest} className="btn rounded-5 text-white btn-green">
                تایید
              </button>
              <button onClick={rejectRequest} className="btn rounded-5 text-white btn-red">
                لغو
              </button>
            </div>
          </div>
          ...
          <div className="my-4 d-flex flex-column">
            <span className="fs-4 fw-bold mt-3">کسب و کار خود را ایجاد کنید</span>
            <div className="d-flex bg-orange rounded-4 p-3 mt-3">
              <Link to="/create-company" className="btn fs-5 text-decoration-none text-white">
          ...
          <div className="d-flex flex-column">
            <span className="fs-4 fw-bold my-3">درباره برنامه حضور و غیاب رایاسان</span>
            <p className="fs-5 text-justifyed">
              این برنامه به شما کمک می‌کند تا ورود و خروج کارمندان خود را در شرکت، کارگاه یا کارخانه مدیریت نمایید.
              با استفاده از این برنامه دیگر نیازی به سیستم‌های حضور غیاب فیزیکی ندارید و به صورت آنلاین و بسیار دقیق‌تر
              می‌توانید ورود و خروج افراد را مدیریت کنید.
            </p>
