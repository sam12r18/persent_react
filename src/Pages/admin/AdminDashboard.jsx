                ...
                <div className={"d-flex flex-column gap-4"}>
                    ...
                    <div className="bg-orange rounded-4 p-3">
                            ...
                            <div className="justify-content-end d-flex">
                                <Link to={`/admin/${status?.last_status === "check_in" ? "exit-confirmation" : "enter-confirmation"}`}  className={`btn ${status?.last_status === "check_in" ? "btn-red" : "btn-green"} rounded-4 text-white `}>
