                ...
                <div className={"d-flex flex-column gap-4"}>
                    <div className="d-flex bg-orange justify-content-between rounded-4 p-3">
                        ...
                        <div className="d-flex align-items-end">
                            <MinLink bgColor={"bg-yellow"} to={"/admin/profile"} text={"تکمیل اطلاعات حساب"}
                                     textColor={"text-black"}/>
                        </div>
                    </div>
                    <div className="bg-orange rounded-4 p-3">
                            <span className="text-white mb-2 fs-4 fw-bold d-block">
                               وضعیت : {status?.last_status === "check_in" ? "حضور در شرکت" : "عدم حضور"}
                            </span>
                        ...
                        <div className="justify-content-end d-flex">
                            <MinLink
                                to={`/admin/${status?.last_status === "check_in" ? "exit-confirmation" : "enter-confirmation"}`}
                                bgColor={`${status?.last_status === "check_in" ? "btn-red" : "btn-green"}`}
                                textColor={"text-white"}
                                text={status?.last_status === "check_in" ? "خروج" : "ورود"}
                            />
                        </div>
                    </div>
                    <div className="d-flex flex-column">
                    ...
                    <div className="d-flex bg-orange justify-content-between rounded-4 p-3">
                        <span className="text-white fs-5"> وظیفه های برای کارمندان</span>
                        <div className="d-flex align-items-end gap-3">
                            <Link to={"/admin/employees-tasks"} className="btn btn-green text-nowrap rounded-4 text-white fs-7">
                                افزودن
                            </Link>
