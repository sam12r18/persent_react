...
import ExitConfirmation from "../Pages/ExitConfirmation"; // ضروری برای رندر نقشه
        ...
        <div>
          <div className="d-flex bg-orange justify-content-between rounded-4 p-3 mt-3">
            ...
            <div className="d-flex align-items-end">
              <Link
                to={"/profile"}
                className="btn bg-yellow text-nowrap rounded-4 text-white fs-7"
              >
                تکمیل اطلاعات حساب
              </Link>
            </div>
          ...
          <div className="row justify-content-around mt-3 gap-2">
            <div className="col-5 bg-orange rounded-4 p-3">
              ...
              <div className="justify-content-end d-flex">
                <Link
                  ...
                  className="btn btn-red px-3 py-2 text-nowrap rounded-4 text-white fs-7"
                >
                  خروج
                </Link>
              </div>
            ...
            <div className="col-5 bg-orange rounded-4 p-3">
              ...
              <div className="justify-content-end d-flex">
                <Link
                  to={"/enter-confirmation"}
                  className={
                    "btn btn-green px-3 py-2 text-nowrap rounded-4 text-white fs-7"
                  }
                >
                  ورود
                </Link>
          ...
          <div className="d-flex bg-orange justify-content-between rounded-4 p-3 mt-3">
            <div>
              <span className="text-white fs-5">مشاهده تاریخچه</span>
            </div>
            <div className="d-flex align-items-end">
              <Link
                to={""}
          ...
          <div className="d-flex bg-orange justify-content-between rounded-4 p-3 mt-3">
            <div>
              <span className="text-white fs-5">وظیفه هایه من </span>
            </div>
            <div className="d-flex align-items-end">
              <Link
                to={"/my-tasks"}
